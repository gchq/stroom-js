...
a:try{var D,E,F,G;if(G="undefined"!=='object'&&module.exports){var H;try{H=crypto;}catch(a){H=null;}G=E=H;}if(G&&E.randomBytes)D=E.randomBytes(128), D=new Uint32Array((new Uint8Array(D)).buffer), sjcl.random.addEntropy(D,1024,"crypto['randomBytes']");else if("undefined"!==typeof window&&"undefined"!==typeof Uint32Array){F=new Uint32Array(32);if(window.crypto&&window.crypto.getRandomValues)window.crypto.getRandomValues(F);else if(window.msCrypto&&window.msCrypto.getRandomValues)window.msCrypto.getRandomValues(F);
...
var authorisationReducer = function (state, action) {
...
var setCanManagerUsers = function (canManageUsers) {
  return {
...
var TOKEN_ID_CHANGE = 'authentication/TOKEN_ID_CHANGE';
...
var sendAuthenticationRequest = function (referrer) {
  return function (dispatch, getState) {
    ...
    var nonce = v4_1();
    var nonceHashBytes = sjcl_1.hash.sha256.hash(nonce);
    var nonceHash = sjcl_1.codec.hex.fromBits(nonceHashBytes);
...
var handleAuthenticationResponse = function (accessCode) {
  return function (dispatch) {
    ...
    .then(function (idToken) {
      var decodedToken = lib(idToken);
      var nonce = localStorage.getItem('nonce');
      var nonceHashBytes = sjcl_1.hash.sha256.hash(nonce);
      var nonceHash = sjcl_1.codec.hex.fromBits(nonceHashBytes);
      var returnedNonce = decodedToken.nonce;
      var referrer = localStorage.getItem('preAuthenticationRequestReferrer');
...
var AuthenticationRequest = (function (Component$$1) {
  function AuthenticationRequest () {
    Component$$1.apply(this, arguments);
  }

  if ( Component$$1 ) AuthenticationRequest.__proto__ = Component$$1;
  AuthenticationRequest.prototype = Object.create( Component$$1 && Component$$1.prototype );
...
var AuthenticationRequest$1 = connect(
  mapStateToProps,
  mapDispatchToProps
...
var HandleAuthenticationResponse = (function (Component$$1) {
  function HandleAuthenticationResponse () {
    Component$$1.apply(this, arguments);
  }

  if ( Component$$1 ) HandleAuthenticationResponse.__proto__ = Component$$1;
  HandleAuthenticationResponse.prototype = Object.create( Component$$1 && Component$$1.prototype );
  HandleAuthenticationResponse.prototype.constructor = HandleAuthenticationResponse;
...
var mapDispatchToProps$1 = function (dispatch) { return bindActionCreators({
}, dispatch); };

var HandleAuthenticationResponse$1 = connect(
  mapStateToProps$1,
  mapDispatchToProps$1
)(HandleAuthenticationResponse);

export { authenticationReducer, authorisationReducer, AuthenticationRequest$1 as AuthenticationRequest, HandleAuthenticationResponse$1 as HandleAuthenticationResponse };
